...
// Вот простая задача на использование метода filter:

// Задача:
// У вас есть массив чисел. Напишите функцию на JavaScript, 
// которая будет использовать метод filter, чтобы отфильтровать и вернуть 
// только те числа, которые больше 10.

const numbers = [5, 12, 8, 130, 44, 7];

// Напишите функцию, которая принимает этот массив и возвращает новый массив,
// содержащий только числа больше 10. После того как напишете решение, 
// пришлите его, и я проверю.
